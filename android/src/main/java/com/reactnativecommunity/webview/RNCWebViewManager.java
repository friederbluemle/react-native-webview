...
public class RNCWebViewManager extends SimpleViewManager<WebView> {
    ...
    public void setAllowsFullscreenVideo(WebView view, @Nullable Boolean allowsFullscreenVideo) {
    ...
    public void setGeolocationEnabled(WebView view, @Nullable Boolean isGeolocationEnabled) {
        view.getSettings()
                .setGeolocationEnabled(isGeolocationEnabled != null && isGeolocationEnabled);
    }
    ...
    protected static class RNCWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView webView, String url, Bitmap favicon) {
            ...
            dispatchEvent(
                    webView,
                    new TopLoadingStartEvent(webView.getId(), createWebViewEvent(webView, url)));
        }
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            dispatchEvent(
                    ...
                    new TopShouldStartLoadWithRequestEvent(
                            view.getId(), createWebViewEvent(view, url)));
            return true;
        }
    ...
    protected static class RNCWebView extends WebView implements LifecycleEventListener {
         ...
         *
         * <p>Activity Context is required for creation of dialogs internally by WebView Reactive
         * Native needed for access to ReactNative internal system functionality
         */
        ...
        protected void onSizeChanged(int w, int h, int ow, int oh) {
            ...
            if (sendContentSizeChangeEvents) {
                dispatchEvent(this, new ContentSizeChangeEvent(this.getId(), w, h));
            }
        }
